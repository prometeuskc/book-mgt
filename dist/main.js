...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [database_1.DatabaseModule, users_module_1.UsersModule],
    })
], AppModule);
...
let UsersService = class UsersService {
    ...
    async createCommand(createUserDto) {
        ...
        if (exists) {
            throw new common_1.BadRequestException('Record is already exists.');
        }
        try {
            ...
            throw new common_1.BadRequestException(error.messages);
        }
    }
    async updateCommand(id, updateUserDto) {
...
async function bootstrap() {
    ...
    swagger_1.SwaggerModule.setup('swagger/index.html', app, document);
